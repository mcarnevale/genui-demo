...
export function TomLindaDashboard({ persona, onRecipeClick, onRecipesTabClick, onGrillTabClick, onHelpTabClick, onPlannerTabClick, onContentTabClick }) {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#FFFBF5" }}>
      ...
      <nav className="flex justify-around py-5 border-t bg-white">
        {[
